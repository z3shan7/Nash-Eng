...
// document.addEventListener("DOMContentLoaded", function () {
//     document.querySelectorAll('<a href^="index.html"></a>').forEach(anchor => {
...
if (screenWidth > 768) {
    document.querySelectorAll('.we-item').forEach(function (item) {
        item.addEventListener('mouseenter', function () {
            ...
            setTimeout(() => {
                if (weIsHovered) {
                    item.querySelectorAll('.txt-overlay, .we-image-item-header, .we-image-item-text, .we-button').forEach(function (child) {
